# QA Lead Portfolio — Дмитрий Завадский
...
📧 scsifair@gmail.com · 💬 Telegram: [@GrafZavadskiy](https://t.me/GrafZavadskiy)
...
### Практические артефакты тестирования

Документы, показывающие, что лид остаётся практиком — а не только управляет процессом.

| Артефакт | Что демонстрирует |
|---|---|
| [Чек-лист авторизации/регистрации](artifacts/checklist-auth-mobile.md) | покрытие пользовательских путей, разделение проверок на happy path / негативные / граничные |
| [Образец баг-репортов](artifacts/bug-reports-sample.md) | оформление дефектов по стандарту: окружение, шаги, ожидаемый и фактический результат, severity, приоритет, влияние |
